/**
 * Genre metadata used to map genre IDs from the podcast API to human-readable titles.
 * Podcast preview data only includes genre IDs; titles come from this file.
 */
export const genres = [
  {
    id: 1,
...
/**
 * Lookup map from genre ID to genre title for quick label resolution.
 * @type {Map<number, string>}
 */
export const genreTitleById = new Map(
